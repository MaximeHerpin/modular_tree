...
class TrunkNode(bpy.types.Node, MtreeFunctionNode):
    ...
    def init(self, context):
        ...
        self.add_input("mt_FloatSocket", "Shape", min_value=0.0001, property_name="shape", property_value=.5)
        self.add_input("mt_FloatSocket", "Up Attraction", property_name="up_attraction", property_value=.1)
