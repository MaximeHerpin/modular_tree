...
class BranchNode(bpy.types.Node, MtreeFunctionNode):
    ...
    def init(self, context):
        ...
        self.add_input("mt_FloatSocket", "Resolution", min_value=0.0001, property_name="resolution", property_value=1)
        self.add_input("mt_FloatSocket", "Start Radius", min_value=0.0001, property_name="start_radius", property_value=.7)
        self.add_input("mt_FloatSocket", "Randomness", min_value=0.0001, property_name="randomness", property_value=.3)
        self.add_input("mt_FloatSocket", "Gravity Strength", property_name="gravity_strength", property_value=.3)
        self.add_input("mt_FloatSocket", "Stiffness", property_name="stiffness", property_value=5)
        self.add_input("mt_FloatSocket", "Up Attraction", property_name="up_attraction", property_value=.3)
        ...
        self.add_input("mt_FloatSocket", "Split proba", min_value=0, max_value=1, property_name="split_proba", property_value=.1)
        self.add_input("mt_FloatSocket", "Split angle", min_value=0, max_value=180, property_name="split_angle", property_value=5.)
